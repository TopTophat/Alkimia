...
import net.falling_pan.alkimia.block.entity.custom.JarBlockEntity;
...
//        System.out.println("Fill " + fillPercentage);
        ...
        float y1 = 1f / 16f;
        float y2 = ((fillPercentage * 10f) / 16f) + y1;

        float minU = sprite.getFrameU(4f / 16f);
        float maxU = sprite.getFrameU(12f / 16f);
        ...
        // front face
        drawQuad(vertexConsumer, entry, 4f / 16f, y1, 4f / 16f, 12f / 16f, y2, 4f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // back face
        drawQuad(vertexConsumer, entry, 12f / 16f, y1, 12f / 16f, 4f / 16f, y2, 12f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // left face
        drawQuad(vertexConsumer, entry, 4f / 16f, y1, 12f / 16f, 4f / 16f, y2, 4f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // right face
        drawQuad(vertexConsumer, entry, 12f / 16f, y1, 4f / 16f, 12f / 16f, y2, 12f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        if(fillPercentage < 1.1f) {
            minU = sprite.getFrameU(4f / 16f);
            maxU = sprite.getFrameU(12f / 16f);
            minV = sprite.getFrameV(4f / 16f);
            maxV = sprite.getFrameV(12f / 16f);

            vertexConsumer.vertex(entry, 4f / 16f, y2, 4f / 16f)
                    .color(color)
                    .texture(minU, maxV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 4f / 16f, y2, 12f / 16f)
                    .color(color)
                    .texture(minU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 12f / 16f, y2, 12f / 16f)
                    .color(color)
                    .texture(maxU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 12f / 16f, y2, 4f / 16f)
                    .color(color)
                    .texture(maxU, maxV)
                    .light(light)
                    .overlay(overlay)
        ...
        if(fillPercentage < 1.1f && firstToRender) {
            ...
            vertexConsumer.vertex(entry, 4f / 16f, y1, 4f / 16f)
                    .color(color)
                    .texture(minU, maxV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 4f / 16f, y1, 12f / 16f)
                    .color(color)
                    .texture(minU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 12f / 16f, y1, 12f / 16f)
                    .color(color)
                    .texture(maxU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 12f / 16f, y1, 4f / 16f)
                    .color(color)
                    .texture(maxU, maxV)
                    .light(light)
                    .overlay(overlay)
