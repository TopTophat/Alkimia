...
public class FluidPedestalBlockEntity extends BlockEntity {
    public int amount = 0; // mB
    public FluidVariant storedFluid = FluidVariant.blank();
    public int capacity = 1000; // mB

    public FluidPedestalBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FLUID_PEDESTAL_BE, pos, state);
    }
