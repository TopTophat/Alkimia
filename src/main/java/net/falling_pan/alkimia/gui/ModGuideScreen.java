package net.falling_pan.alkimia.gui;

import net.falling_pan.alkimia.component.ModDataComponentTypes;
import net.falling_pan.alkimia.gui.data.BookData;
import net.falling_pan.alkimia.gui.data.EntryData;
import net.falling_pan.alkimia.gui.data.GuidebookData;
import net.falling_pan.alkimia.gui.data.PageData;
