...
public abstract class SoulFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.SOUL;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.SOUL_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.SOUL.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    @Override
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.SOUL || fluid == ModFluids.FLOWING_SOUL;
    }
