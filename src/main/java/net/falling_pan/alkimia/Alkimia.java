package net.falling_pan.alkimia;
...
import net.falling_pan.alkimia.item.ModItemGroups;
import net.falling_pan.alkimia.item.ModItems;
import net.falling_pan.alkimia.item.custom.FlashPowderItem;
import net.falling_pan.alkimia.item.custom.FlaskItem;
import net.falling_pan.alkimia.item.custom.VialItem;
import net.falling_pan.alkimia.item.custom.TinyVialItem;
...
public class Alkimia implements ModInitializer {
	...
	public void onInitialize() {
		...
		//TODO: #CODING ARCANE CRAFTING = CRUCIBLE WITH GOOD CONTENTS + ITEM PEDESTALS + FLUID PEDESTALS (GLOBES)(FLOAT UP DOWN SINE WAVE) + CENTRAL PEDESTAL
		//TODO: #CODING ADD THE PIPETTE(shift + click to change between deposit/take 1mb / 5mb / 10mb / 20mb capacity 100mb)
		...
		//TODO: #PAINTING PAINT PIPETTE TEXTURE
