...
public class Lens extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<Lens> CODEC = Lens.createCodec(Lens::new);

    public Lens(Settings settings) {
        super(settings);
    }
