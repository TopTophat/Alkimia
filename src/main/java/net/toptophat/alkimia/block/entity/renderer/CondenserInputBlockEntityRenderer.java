...
import net.toptophat.alkimia.block.entity.custom.CondenserInputBlockEntity;
...
public class CondenserInputBlockEntityRenderer implements BlockEntityRenderer<CondenserInputBlockEntity> {
    public CondenserInputBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    @Override
    public void render(CondenserInputBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
