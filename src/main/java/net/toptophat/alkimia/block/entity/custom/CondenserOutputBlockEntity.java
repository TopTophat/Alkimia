...
public class CondenserOutputBlockEntity extends BlockEntity{
    ...
    public CondenserOutputBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CONDENSER_OUTPUT_BE, pos, state);
    }
