...
import net.toptophat.alkimia.block.entity.custom.CompressorBlockEntity;
...
public class CompressorBlockEntityRenderer implements BlockEntityRenderer<CompressorBlockEntity> {
    public CompressorBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
