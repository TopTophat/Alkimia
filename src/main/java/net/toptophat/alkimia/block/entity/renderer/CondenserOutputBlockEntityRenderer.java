...
import net.toptophat.alkimia.block.entity.custom.CondenserOutputBlockEntity;
...
public class CondenserOutputBlockEntityRenderer implements BlockEntityRenderer<CondenserOutputBlockEntity> {
    public CondenserOutputBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    @Override
    public void render(CondenserOutputBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
