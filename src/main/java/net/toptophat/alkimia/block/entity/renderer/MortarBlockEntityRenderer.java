...
//        System.out.println("Fill " + fillPercentage);
        ...
        float y1 = 2f / 16f;
        float y2 = ((fillPercentage * 2f) / 16f) + y1;
        ...
        // front face
        drawQuad(vertexConsumer, entry, 4.001f / 16f, y1, 4.001f / 16f, 11.999f / 16f, y2, 4.001f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // back face
        drawQuad(vertexConsumer, entry, 11.999f / 16f, y1, 11.999f / 16f, 4.001f / 16f, y2, 11.999f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // left face
        drawQuad(vertexConsumer, entry, 4.001f / 16f, y1, 11.999f / 16f, 4.001f / 16f, y2, 4.001f / 16f, minU, minV, maxU, maxV, color, light, overlay);

        // right face
        drawQuad(vertexConsumer, entry, 11.999f / 16f, y1, 4.001f / 16f, 11.999f / 16f, y2, 11.999f / 16f, minU, minV, maxU, maxV, color, light, overlay);
        ...
        if(fillPercentage < 1.1f) {
            ...
            vertexConsumer.vertex(entry, 4.001f / 16f, y2, 4.001f / 16f)
                    .color(color)
                    .texture(minU, maxV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 4.001f / 16f, y2, 11.999f / 16f)
                    .color(color)
                    .texture(minU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 11.999f / 16f, y2, 11.999f / 16f)
                    .color(color)
                    .texture(maxU, minV)
                    .light(light)
                    .overlay(overlay)
            ...
            vertexConsumer.vertex(entry, 11.999f / 16f, y2, 4.001f / 16f)
                    .color(color)
                    .texture(maxU, maxV)
                    .light(light)
                    .overlay(overlay)
